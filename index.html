...
<div id="instructions">
操作说明：PC键盘：← → 移动，↓软下落，上旋转 | 手机滑动：左右滑动→移动，上滑→旋转，下滑→软下落
</div>
...
canvas.addEventListener("touchend",e=>{
 inputState.left=false; inputState.right=false; inputState.down=false; inputState.up=false;
},{passive:false});
